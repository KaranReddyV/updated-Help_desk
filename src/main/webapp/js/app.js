var app=angular.module('exampleApp', ['ui.router', 'ngCookies', 'exampleApp.services','ui.bootstrap']);
var TICKET_APP="http://localhost:8082/Ticket/rest";
  app .config(
